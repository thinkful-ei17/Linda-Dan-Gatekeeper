...
function gateKeeper(req, res, next) {
    ...
    const parsed = queryString.parse(head);
    console.log(parsed);
    // const { pass, user } = parsed
    // console.log(pass);
    console.log(USERS);
    //USERS.userName.find(user);
    const user = USERS.find(user => user.userName === parsed.user && user.password === parsed.pass);
    req.user = user;    
